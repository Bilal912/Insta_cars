...
import com.panaceasoft.admotors.Review_Add;
    ...
    public void navigateToCamera(Activity activity, String flag) {
        ...
        if (takePictureIntent.resolveActivity(activity.getPackageManager()) != null) {
            ...
            if (photoFile != null) {
              ...
              //  Toast.makeText(activity, String.valueOf(photoURI), Toast.LENGTH_SHORT).show();
...
//        intent.putExtra(Constants.ITEM_ID, item.id);
    ...
    public void navigateToAddActivity(Activity activity, String userId, String itemId) {
        Intent intent = new Intent(activity, Review_Add.class);
        intent.putExtra(Constants.USER_ID, userId);
        intent.putExtra(Constants.ITEM_ID, itemId);
         activity.startActivity(intent);
    }
